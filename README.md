...
> 📘 **처음 쓰신다면 [기능 안내](https://seotk0319.github.io/NAIS3-Custom/)부터 읽어 주세요.** 메인·씬·디렉터·라이브러리·알림 화면마다 어떤 기능이 어디에 있는지 사진으로 정리했어요.
> 설치 파일은 [Releases](https://github.com/seotk0319/NAIS3-Custom/releases/latest)에서 `nais3-custom-…-setup.exe` 하나만 받으면 돼요.
...
3. 그 창에서 사이트에 로그인한 뒤 **창을 닫으면** NAIS3가 알아서 연결을 마칩니다. 연결되지 않았다면 **로그인 완료**를 누릅니다. 이미 로그인돼 있으면 확인용 창이 잠깐 열렸다 저절로 닫힙니다.
